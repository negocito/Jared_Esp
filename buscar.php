		...
		<nav class="navbar navbar-expand-lg container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    ...
		    <form method="POST" class="form-inline my-2 my-lg-0" action="buscar.php">
		      ...
		      <button action ="" class="btn btn-outline-success my-2 my-sm-0" type="submit" name="envio">Buscar</button>
		    </form >
	...
	<?php
		   if(!isset ($envio)){
		   	 ...
		   	 exit;
						...
						$consulta = mysqli_query($conn,'select * FROM general WHERE nombre LIKE' .$nombre);
					...
					//<!--libros-->
						...
						echo '<a href="'.$zelda.'" class="btn btn-danger  btn-block col-md-6">Descargar</a>';
						echo '</div>';
						echo '</div>';
						echo '</div>';
						echo '</div>';	
