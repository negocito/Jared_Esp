...
<!-- NAVBAR-->
	<div class="container-fluid navbar-dark bg-dark fixed-top">
		<nav class="navbar navbar-expand-lg container">
		  <a class="navbar-brand" href="index.html"> TULIBROS.COM</a>
	...
	<div class="container d-flex flex-column justify-content-center h-100 align-items-center py-3">
			<h1><b>REVISTAS</b></h1>
			<P><b> Descarga la revista que quieras :D , son !GRATIS!</b></P>
		...
		<div class="container py-5">
			<div class="row">
				<?php
						...
						$consulta = mysqli_query($conn,'select nom_revista,descripcion,imagen,zelda FROM revistas');
						while ($fila = mysqli_fetch_array($consulta))
						{
						$name= $fila['nom_revista'];
						...
						echo '<a href="'.$zelda.'" target="_blank" class="btn btn-danger  btn-block col-md-6">Descargar</a>';
						echo '</div>';
						echo '</div>';
						echo '</div>';
						echo '</div>';
