...
<!-- NAVBAR-->
	...
	<div class="container d-flex flex-column justify-content-center h-100 align-items-center py-3">
			<h1><b>LIBROS</b></h1>
			<P><b> Descarga el libro que quieras :D , son !GRATIS! </b></P>
		...
		<div class="container py-5">
			<div class="row">
				<?php
						...
						$consulta = mysqli_query($conn,'select nombre_libro,descripcion,imagen FROM libros');
						while ($fila = mysqli_fetch_array($consulta))
						{
						$name= $fila['nombre_libro'];
	...
	<!-- MOSTRADO DE CARDS , DE LOS LIBROS  fin-->
...
<form action="envia.php" method="POST" class="row ">
	...
	<!--footer-->
	<footer class="container-fluid bg-light text-center text-darkpy-2"><p>DESAROLLADO POR EL TEAM RECURSADORES HASTA EL FIN</p>
	</footer>
